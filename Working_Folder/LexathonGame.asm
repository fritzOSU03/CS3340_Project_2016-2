...
#
#	Code in this function is the same code Michael used to display
#	his final "Game Over" screen. Displays final score
#
main.End:
	li	$v0, 4				# Load syscall print string service
...
#
#	These are the same functions Michael used to display the instructions
